...
def add_questions():
    questions = [
        ('Сколько месяцев в году имеют 31 день?', 'Один', 'Двенадцать', 'Семь', 'Шесть'),
        ('Какая самая большая страна?', 'Россия', 'Китай', 'Казахстан', 'США'),
        ('За чем язык во рту?', 'Проглатывать пищу', 'За зубами', 'Разжевывать пищу', 'За губами'),
        ('Какие камни в море?', 'Серые', 'Сухие', 'Острые', 'Мокрые'),
        ('Где конь через коня перепрыгивает?', 'На совернованиях', 'В конюшне', 'В шахматах', 'В доме'),
        ('Что тяжелее: киллограмм ваты или килограмм железа?', 'Сахарная вата', 'Килограмм железа', 'Килограмм ваты', 'Одинаковы')
    ]
    open()
